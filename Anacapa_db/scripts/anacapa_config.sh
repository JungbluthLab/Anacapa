...
#load cutadapt
CUTADAPT="/usr/local/anacapa/miniconda/bin/cutadapt" 		#version 1.16 path to cutadapt binary. See documentation for how to obtain this script
...
#load bowtie2
BOWTIE2="/usr/local/anacapa/miniconda/bin/bowtie2"							# version 2.3.4 or what ever code is used to load bowtie2 in a bash shell, or path to bowtie2
